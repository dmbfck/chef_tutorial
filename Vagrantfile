...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "georobarm-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/cheft_blah"
  #   chef.validation_client_name = "cheft_blah-validator"
  #   chef.validation_key_path = ".chef/cheft_blah-validator.pem"
  # end
end
